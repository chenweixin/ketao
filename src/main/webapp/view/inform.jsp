...
<body>
  ...
  <div class="base-container">
    ...
    <div class="content">
      ...
      <form class="searchbar" action="/ketao/inform/getinforms" onsubmit="return checkFields()">
    ...
    <div class="content">
      ...
      <p class="inline-block">发布新的公告请点击</p>
      <a href="/ketao/view/addinform.jsp" class="inline-block text-btn">添加</a>
      
    </div>
    
    <div class="content">
      <div class="content-titlebar">
        <p class="text-title inline-block">查看全部公告</p>
      </div>
      <p class="inline-block">查看所有的公告的列表</p>
      <a href="/ketao/inform/getall" class="inline-block text-btn">查看</a>
