...
<body>
  ...
  <div class="base-container">
    ...
    <div class="content">
      ...
      <div>
        ...
        <button class="base-btn btn-normal" onclick="deleteinforms()">删除</button>
      ...
      <table class="table">
	    ...
	    <tr>
	      ...
	      <td><a class="text-btn" href="/ketao/inform/get?informid=${item.id }">${item.title }</a></td>
	      <td>${item.content}</td>
  ...
  <script type="text/javascript">
     ...
     */
    function turnToAdd(){
    	window.location.href = "/ketao/view/addinform.jsp"
    }
  </script>
</body>
</html>
